package ir.hosseini.shalimanagment.ui.SubmittedRices;
...
public class SubmittedRicesFragment extends Fragment implements TextView.OnEditorActionListener, View.OnClickListener {

    RecyclerView recyclerView;
    List<Berenj> list;

    RicesAdapter adapter;
            ...
            public void onResponse(Call<List<Farmer>> call, Response<List<Farmer>> response) {
                ...
                if (response.body() != null) {
                    ...
                    for (Farmer res : response.body()) {
                        if (res.getBerenj() != null) {
                            list.addAll(Arrays.asList(res.getBerenj()));
                        }
                    }

                    adapter = new RicesAdapter(SubmittedRicesFragment.this, list);

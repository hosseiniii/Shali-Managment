package ir.hosseini.shalimanagment.ui.SubmittedShalis;
...
public class SubmittedShalisFragment extends Fragment implements TextView.OnEditorActionListener, View.OnClickListener {

    RecyclerView recyclerView;
    List<Shali> list;
    ShalisAdapter adapter;
                ...
                if (response.body() != null) {
                    ...
                    for (Farmer res : response.body()) {
                        if (res.getShaliha() != null) {
                            list.addAll(Arrays.asList(res.getShaliha()));
                        }
                    }

                    adapter = new ShalisAdapter(SubmittedShalisFragment.this, list);
